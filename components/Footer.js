    ...
    <>
      <footer>
        <div className="fixed bottom-[30px] right-[30px]">
          <Link href="mailto:creative@spotler.co.uk?subject=Suggestions" scroll={false}>
            <svg className="w-[60px]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="#5cd975">
        ...
        <div className="bg-[#001d34]">
          <nav className="text-white text-xs h-[100px] flex items-center justify-center py-[30px] px-[30px]">Copyright {date.getFullYear()} Spotler</nav>
        </div>
      </footer>
    </>
  );
