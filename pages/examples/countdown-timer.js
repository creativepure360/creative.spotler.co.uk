      ...
      <section className="max-w-screen-lg mx-auto mb-14 px-4 sm:px-8">
        ...
        >
          <div className="text-center">
            <h2 className="font-avant-garde-bold text-floss-pink text-3xl sm:text-5xl leading-10 sm:leading-14 mb-4 sm:mb-10">
              Lorem ipsum dolor!
            </h2>
            ...
            <div className="grid grid-cols-4 gap-4 mb-6 sm:mb-12 font-proxima-bold text-floss-pink text-xs sm:text-base uppercase">
            ...
            <a
             ...
             hover:bg-white hover:shadow-full inline-block cursor-pointer px-8 py-2"
